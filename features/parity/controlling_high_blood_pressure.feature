...
Feature: Controlling High Blood Pressure — Million Hearts (CRS v25 §2.6.2)
  ...
  Scenario: Current pregnancy excludes the patient
    Given a User Population patient "H-PREG" aged 30 at period end
  ...
  Scenario: Last BP of the period controls
    ...
    And "H-CTRL" has a BP reading of 152/96 on 2025-03-11
    And "H-CTRL" has a BP reading of 124/80 on 2025-11-19
    When the National GPRA report is run
  ...
  Scenario: Exactly 140/90 is not controlled
    ...
    And "H-EDGE" has a BP reading of 140/90 on 2025-06-14
    When the National GPRA report is run
  ...
  Scenario: Same-day readings — the controlled reading is preferred
    ...
    And "H-SAMEDAY" has a BP reading of 148/94 on 2025-09-05
    And "H-SAMEDAY" has a BP reading of 132/84 on 2025-09-05
    When the National GPRA report is run
